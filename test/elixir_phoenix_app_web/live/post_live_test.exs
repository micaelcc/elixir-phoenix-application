defmodule ElixirPhoenixAppWeb.PostLiveTest do
  use ElixirPhoenixAppWeb.ConnCase

  import Phoenix.LiveViewTest
  import ElixirPhoenixApp.TimelineFixtures

  @create_attrs %{nickname: "some nickname", content: "some content", likes: 42, reposts: 42, deleted: true}
  @update_attrs %{nickname: "some updated nickname", content: "some updated content", likes: 43, reposts: 43, deleted: false}
  @invalid_attrs %{nickname: nil, content: nil, likes: nil, reposts: nil, deleted: false}
